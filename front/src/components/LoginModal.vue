    ...
    <div class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" ref="modal">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                <div class="py-3 text-2xl font-bold text-center">Login form</div>
...
export default {
    ...
    methods: {
        onSubmit(evt) {
            evt.preventDefault();
            axios
                .post(`https://back.node.amaurel.tk/user/login`, this.form)
                .then((response) => {
        ...
        emitToParent() {
            this.$emit('childToParent', this.isLoginModalActive);
        },
    },
};
</script>
